                ...
                <div class="col">
                    ...
                    <table class="table-hover table-condensed table-bordered"style="margin-left:auto;margin-right:auto;">
                        <th>
                            ...
                            <td scope="col" class="text-center py-2"style="font-size:30px;"><b>Name</b></td>
                            <td scope="col" class="text-center py-2"style="font-size:30px;"><b>E-Mail</b></td>
                            <td scope="col" class="text-center py-2"style="font-size:30px;"><b>Balance</b></td>
                            <td scope="col" class="text-center py-2"style="font-size:30px;"><b>Operation</b></td>
                            </tr>
                        </th>
                        <tbody>
                <?php 
